...
sweep_id = wandb.sweep(sweep_config, project = "ALBERT-IMDB", entity="madhudorai24")
...
#TRANSFORMER MODEL
def ret_model():
    model = AlbertForSequenceClassification.from_pretrained("albert-base-v2",num_labels=2, return_dict = True)
    return model
...
def train_valid_test():
    ...
    for epoch_i in range(0, epochs):
        ...
        checkpoint_directory = "/export/livia/home/vision/Mdoraiswamy/albert-imdb-model"
