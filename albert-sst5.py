...
sweep_id = wandb.sweep(sweep_config, project = "ALBERT-SST5", entity="madhudorai24")
...
#TRANSFORMER MODEL
def ret_model():
    model = AlbertForSequenceClassification.from_pretrained("albert-base-v2",num_labels=5, return_dict = True)
    return model
